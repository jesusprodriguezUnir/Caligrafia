...
async function generate() {
  ...
  for (const cat of CATEGORIAS) {
    for (let i = 0; i < 3; i++) {
        ...
        page.drawText("Caligra-fiate - Ejercicio Real: " + ejercicio.nombre, {
            x: 50,
            y: 30,
            size: 10,
            font: fontNormal,
  ...
  console.log('✅ Todos los PDFs de prueba han sido generados exitosamente en public/test-cuadernos/');
}
